...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/bare/installing-expo-modules.mdx)
...
1| 1| override func bundleURL() -> URL? {
---|---|---
2| 2| #if DEBUG
...
4| 4| #else
5| 5|  Bundle.main.url(forResource: "main", withExtension: "jsbundle")
6| 6| #endif
7| 7| }
