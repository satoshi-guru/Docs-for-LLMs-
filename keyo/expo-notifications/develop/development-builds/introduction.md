...
[Expo Go to development buildLearn how to migrate an existing Expo Go project to using development builds.](/develop/development-builds/expo-go-to-dev-build) [Local app developmentHow to build a development client on your local machine.](/guides/local-app-development) [Development builds on EASHow to build a development client on EAS.](/develop/development-builds/create-a-build)