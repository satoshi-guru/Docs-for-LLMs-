...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/linking/into-your-app.mdx)
...
You can observe links that launch your app using the [`Linking.useLinkingURL()`](/versions/latest/sdk/linking#uselinkingurl) hook from [`expo-linking`](/versions/latest/sdk/linking).
