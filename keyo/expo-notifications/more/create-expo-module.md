...
url: https://docs.expo.dev/more/create-expo-module
---
...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/more/create-expo-module.mdx)
...
[Expo Modules API: Get startedLearn how to create and use local and standalone Expo modules.](/modules/get-started) [expo-module.config.jsonUnderstand the module configuration file used by Expo Autolinking.](/modules/module-config) [How to use a standalone Expo moduleSee how to use standalone modules in monorepos and publish them to npm.](/modules/use-standalone-expo-module-in-your-project)