...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/more/glossary-of-terms.mdx)
...
A file watcher daemon which [Metro](/more/glossary-of-terms#metro-bundler) can optionally use to crawl and query a project's files. Watchman contains native code and may cause issues when installed globally. Watchman is maintained by [Meta](/more/glossary-of-terms#meta).
