...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/router/introduction.mdx)
...
[Expo TutorialA step-by-step guide to build an Expo app that runs on Android, iOS, and web.](/tutorial/introduction) [Expo Router API referenceAPI components, hooks, methods, and configuration options.](/versions/latest/sdk/router) [Expo Router video playlistA tutorial series from core concepts to more complex navigation flows.](https://www.youtube.com/playlist?list=PLsXDmrmFV_AT17JDf-otXSNE_eH7s0uDD)
...
[Manual installationDetailed instructions on how to get started and add Expo Router to your existing app.](/router/installation) [Router 101For information core concepts, notation patterns, navigation layouts, and common navigation patterns, start with Router 101 section.](/router/basics/core-concepts) [Example appSee the source code for the example app on GitHub.](https://github.com/expo/expo/tree/main/templates/expo-template-tabs)