...
This allows you to write [`Contact.getAll()`](/versions/latest/sdk/contacts#contactgetalloptions) and read the contacts from the device, read the gyroscope sensor to detect device movement, or start the phone's camera and take photos.
