...
> This is documentation for the next SDK version. For up-to-date documentation, see the [latest version](/versions/latest) (SDK 56).

# Expo SDK reference

[Edit page](https://github.com/expo/expo/edit/main/docs/pages/versions/unversioned/index.mdx)
...
This allows you to write [`Contact.getAll()`](/versions/unversioned/sdk/contacts#contactgetalloptions) and read the contacts from the device, read the gyroscope sensor to detect device movement, or start the phone's camera and take photos.
...
[Install Expo SDK packages in existing React Native appsLearn more about configuring projects created with `npx @react-native-community/cli@latest init` to Expo SDK packages.](/bare/installing-expo-modules) [Use librariesLearn how to install Expo SDK packages in your project.](/workflow/using-libraries)
