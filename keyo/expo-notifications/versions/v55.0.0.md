...
url: https://docs.expo.dev/versions/v55.0.0
---
...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/versions/v55.0.0/index.mdx)
...
This allows you to write [`Contacts.getContactsAsync()`](/versions/v55.0.0/sdk/contacts#contactsgetcontactsasynccontactquery) and read the contacts from the device, read the gyroscope sensor to detect device movement, or start the phone's camera and take photos.
...
We work closely with the team at Meta to ensure that any urgent fixes are included in the React Native version used by the latest Expo SDK. If your issue won't be cherrypicked into an existing release because it is more niche, or it involves a breaking change, then you have two options:
  ...
  2. Use a [pre-release version of the Expo SDK](/versions/v55.0.0#using-pre-release-versions). An ([example](https://expo.dev/changelog/react-native-78)).
