...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/versions/v56.0.0/index.mdx)
...
This allows you to write [`Contact.getAll()`](/versions/v56.0.0/sdk/contacts#contactgetalloptions) and read the contacts from the device, read the gyroscope sensor to detect device movement, or start the phone's camera and take photos.
