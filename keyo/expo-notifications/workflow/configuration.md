...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/workflow/configuration.mdx)
...
[App config schema referenceExplore the full schema of the app config (app.json/app.config.js).](/versions/latest/config/app)
