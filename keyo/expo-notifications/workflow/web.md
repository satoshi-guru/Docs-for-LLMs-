...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/workflow/web.mdx)
...
[File-based routingBuild routes and navigation with Expo Router.](/router/introduction) [Static rendering and SEORender your website as static HTML with Expo Router to improve SEO and performance.](/router/web/static-rendering) [Deploy instantly with EAS HostingEAS Hosting is the best way to deploy your Expo Router and React Native web apps with support for custom domains, SSL, and more.](/eas/hosting/get-started) [Customizing the JavaScript bundlerCustomize Metro bundler for your project.](/guides/customizing-metro)